...
class TestIncentive private constructor() {
    companion object {
        private const val END_1 = "2021-09-21T16:05:47-00:00"
        private const val END_2 = "2021-09-22T16:05:47-00:00"
        ...
        val incentive1 =
            Incentive(
                ...
                null,
                "Slotti syö nuubels",
                OffsetDateTime.ofInstant(Instant.from(DateTimeFormatter.ISO_INSTANT.parse(END_1)), ZoneId.of("Z")),
        ...
        val incentive2 =
            Incentive(
                ...
                OffsetDateTime.ofInstant(Instant.from(DateTimeFormatter.ISO_INSTANT.parse(END_2)), ZoneId.of("Z")),
                IncentiveType.OPEN,
