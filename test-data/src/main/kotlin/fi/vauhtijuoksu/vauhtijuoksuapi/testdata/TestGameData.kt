...
class TestGameData private constructor() {
    companion object {
        ...
        val gameData1 = KInstancio.create<GameData>()
            .copy(
                startTime = toDate(early_start),
                endTime = toDate(end),
                participants = listOf(
...
//        )
        ...
        val gameData2 = KInstancio.create<GameData>().copy(
            startTime = toDate(late_start),
            endTime = toDate(end),
            participants = listOf(
...
//        )
        ...
        val gameData3 = KInstancio.create<GameData>()
            .copy(
                startTime = toDate(early_start),
                endTime = toDate(end),
                participants = listOf(
