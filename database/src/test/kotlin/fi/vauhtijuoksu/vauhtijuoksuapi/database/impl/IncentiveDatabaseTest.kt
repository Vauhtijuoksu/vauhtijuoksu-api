...
class IncentiveDatabaseTest : VauhtijuoksuDatabaseTest<Incentive>() {
    override fun existingRecord1(): Incentive = TestIncentive.incentive1

    override fun existingRecord2(): Incentive = TestIncentive.incentive2

    override fun newRecord(): Incentive = TestIncentive.incentive3

    override fun tableName(): String = "incentives"

    override fun copyWithId(
        oldRecord: Incentive,
        newId: UUID,
    ): Incentive = oldRecord.copy(id = newId)

    override fun getDatabase(injector: Injector): VauhtijuoksuDatabase<Incentive> = injector.getInstance(IncentiveDatabase::class.java)
    ...
    fun testUpdate() =
        runTest {
            ...
            db
                .update(existingRecord1().copy(title = "Changed the title"))
                .coAwait()
