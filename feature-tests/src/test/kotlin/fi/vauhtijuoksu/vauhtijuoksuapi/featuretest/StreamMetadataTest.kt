    ...
    private val someMetadata = """
        {
          ...
          "timers": [
                {            
                    "start_time": "2020-09-21T15:05:47.000+00:00",
                    "end_time": "2020-09-21T16:05:47.000+00:00"
                }
            ]
        }
    """.trimIndent()
                ...
                testContext.verify {
                    ...
                    val expectedData = JsonObject(someMetadata)
                        .put(
                            ...
                            listOf(
                                JsonObject()
                                    .put("start_time", "2021-09-21T15:05:47.000+00:00")
                                    .put("end_time", "2021-09-21T16:05:47.000+00:00")
                            )
                        )
                    assertEquals(expectedData, res.bodyAsJsonObject())
                }
